...
<script type="text/javascript">
  $(document).ready(function(){
    $('#print_title').text('Contractors List');
    $('#btnContractorsPreview').click();
  });
</script>
...
<table class="table table-bordered" style="margin:0; width:100%; border:1px solid black !important;">
  ...
  <tr style="border:1px solid black;">     
          ...
          <th style="border:1px solid black !important; text-align:left !important;">Contractor's Name</th>
           <th style="border:1px solid black !important; text-align:center !important;">Contractor's Contact Person</th>
          <th style="border:1px solid black !important; text-align:center !important;">Contractor's Contact No</th>
		</tr>
</thead>
<tbody>
         <tr>
      ...
      <td style="border:1px solid black !important; text-align: center !important;"> {{$contractor->contractor_name}}
      </td>
      <td style="border:1px solid black !important; text-align: center !important;">{{$contractor->contractor_contact_person}}</td>   
      <td style="border:1px solid black !important; text-align: center !important;">{{$contractor->contractor_contact_no}}</td>           
   </tr>
    @endforeach
    <tr>
 ...
 <button id="btnContractorsPreview" style="visibility:hidden;">Print</button>
@endsection
